export enum Action {
    ...
    UPDATE_CATEGORIZATION_MODE_STATUS = '@@UPDATE_CATEGORIZATION_MODE_STATUS',
    ...
    UNDO_LABELS_STATE = '@@UNDO_LABELS_STATE',
    CLEAR_LABELS_HISTORY = '@@CLEAR_LABELS_HISTORY',
    ...
    UPDATE_ACTIVE_PROJECT_ID = '@@UPDATE_ACTIVE_PROJECT_ID',
